...
namespace Encrypter
{
    public sealed partial class MyEncrypter
    {
        ...
        private static MyEncrypter _SingleEncrypter { get; set; }
        public static MyEncrypter GetInstance()
        {
            if (_SingleEncrypter == null)
            {
                _SingleEncrypter = new MyEncrypter();
            }
